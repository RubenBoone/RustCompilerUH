...
struct DeclaringStm : public Stm_
{
    ...
    DeclaringStm(std::string i, bool m, Type t) : id(i), isMutable(m), typee(t) {}
};
...
struct LetStm : public Stm_
{
    ...
    LetStm(std::string i, bool m, Type t, Exp e) : id(i), isMutable(m), typee(t), exp(e)
    {
        std::cout << isMutable << std::endl;
    }
    LetStm(std::string i, bool m, Exp e) : id(i), isMutable(m), exp(e)
    {
        std::cout << isMutable << std::endl;
    }
};
...
struct FuncStm : public Stm_
{
    ...
    FuncStm(std::string i, StmList a, Type r, Stm b) : id(i), args(a), returnType(r), body(b) {}
};
...
struct ParamStm : public Stm_
{
    ...
    ParamStm(std::string i, bool m, Type t) : id(i), isMutable(m), type(t) {}
};
